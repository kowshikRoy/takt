...
class _GenderRulesGuideScreenState extends State<GenderRulesGuideScreen> {
  ...
  final List<GenderSuffixRuleItem> _allRules = [
    ...
    // ==================== SEMANTIC / MEANING-BASED RULES ====================
    // These aren't about how a word ends — the gender follows from what kind of
    // thing the word names (a day, a season, a metal, a river...).
    GenderSuffixRuleItem(
      suffix: 'Days',
      genderCode: 'm',
      certainty: '100%',
      title: 'Days of the Week are 100% Masculine (Der)',
      description: 'Every day of the week is masculine, with zero exceptions.',
      examples: ['der Montag', 'der Dienstag', 'der Mittwoch', 'der Donnerstag', 'der Freitag', 'der Samstag', 'der Sonntag'],
    ),
    GenderSuffixRuleItem(
      suffix: 'Months',
      genderCode: 'm',
      certainty: '100%',
      title: 'Months of the Year are 100% Masculine (Der)',
      description: 'Every month is masculine, with zero exceptions.',
      examples: ['der Januar', 'der Februar', 'der März', 'der April', 'der Mai', 'der Juni', 'der Juli', 'der August', 'der September', 'der Oktober', 'der November', 'der Dezember'],
    ),
    GenderSuffixRuleItem(
      suffix: 'Seasons',
      genderCode: 'm',
      certainty: '100%',
      title: 'Seasons are 100% Masculine (Der)',
      description: 'All four seasons are masculine, with zero exceptions.',
    ...
    GenderSuffixRuleItem(
      ...
      genderCode: 'm',
      certainty: '~90%',
      title: 'Weather Phenomena are Masculine (Der)',
      description: 'Individual weather events — rain, snow, wind, storms, fog, frost — are masculine.',
      examples: ['der Regen', 'der Schnee', 'der Wind', 'der Sturm', 'der Nebel', 'der Donner', 'der Blitz', 'der Frost', 'der Hagel'],
      exceptions: ['das Wetter', 'das Gewitter', 'das Eis'],
      exceptionNote: 'The general word for "weather" itself, and "thunderstorm," are neuter rather than masculine.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Drinks',
      genderCode: 'm',
      certainty: '~85%',
      title: 'Alcoholic & Hot Drinks are Masculine (Der)',
      description: 'Wine, spirits, coffee, and tea are masculine.',
      examples: ['der Wein', 'der Sekt', 'der Wodka', 'der Whisky', 'der Schnaps', 'der Kaffee', 'der Tee', 'der Rum'],
      exceptions: ['das Bier'],
      exceptionNote: 'Beer is the one drink every learner needs to remember is neuter, not masculine.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Cars',
      genderCode: 'm',
      certainty: '~95%',
      title: 'Car Brand Names are Masculine (Der)',
      description: 'Car makes take masculine gender because they stand in for "der Wagen" (the car) — the brand name itself borrows the category noun\'s gender, not its own ending.',
      examples: ['der Audi', 'der BMW', 'der Mercedes', 'der Volkswagen', 'der Opel', 'der Ford', 'der Porsche'],
      exceptionNote: 'Motorcycle brands sometimes go the other way (die BMW, the motorbike) because "die Maschine" is feminine — context decides which category noun is implied.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Rivers (intl.)',
      genderCode: 'm',
      certainty: '~85%',
      title: 'Foreign Rivers are Masculine (Der)',
      description: 'Major rivers outside German-speaking Europe are usually masculine, unlike most native German rivers, which are typically feminine (die Elbe, die Oder, die Donau, die Isar).',
      examples: ['der Nil', 'der Amazonas', 'der Mississippi', 'der Ganges', 'der Jordan', 'der Kongo'],
      exceptions: ['der Rhein', 'der Main'],
      exceptionNote: 'The Rhein and the Main are the two famous masculine exceptions among the (mostly feminine) rivers of Germany itself.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Trees',
      genderCode: 'f',
      certainty: '~85%',
      title: 'Tree Species are Feminine (Die)',
      description: 'Most individual tree and plant species are feminine, even though the general word "der Baum" (tree) is masculine.',
      examples: ['die Eiche', 'die Buche', 'die Birke', 'die Tanne', 'die Kiefer', 'die Palme', 'die Fichte', 'die Weide'],
      exceptions: ['der Ahorn'],
      exceptionNote: 'Maple is the classic masculine exception among tree species.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Numbers',
      genderCode: 'f',
      certainty: '100%',
      title: 'Numbers Used as Nouns are Feminine (Die)',
      description: 'Cardinal numbers, when used as nouns rather than counting words, are always feminine — e.g. a grade, a bus line, or a playing-card value.',
      examples: ['die Eins', 'die Zwei', 'die Drei', 'die Hundert', 'die Million', 'die Milliarde'],
    ),
    GenderSuffixRuleItem(
      suffix: 'Metals',
      genderCode: 'n',
      certainty: '~90%',
      title: 'Metals & Elements are Neuter (Das)',
      description: 'Metals and chemical elements are neuter.',
      examples: ['das Gold', 'das Silber', 'das Eisen', 'das Kupfer', 'das Aluminium', 'das Uran', 'das Blei', 'das Zink'],
      exceptions: ['der Stahl'],
      exceptionNote: 'Steel is an alloy rather than a pure element, and takes masculine gender instead.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Countries',
      genderCode: 'n',
      certainty: '~80%',
      title: 'Country & City Names are Mostly Neuter (Das)',
      description: 'Country and city names are grammatically neuter, which is why most are used without any article at all ("Ich fahre nach Deutschland"). A specific, memorizable list of countries deviates from this — some are feminine, some masculine, and a few only exist in the plural.',
      examples: ['(das) Deutschland', '(das) Frankreich', '(das) Italien', '(das) Berlin'],
      exceptions: ['die Schweiz', 'die Türkei', 'die Ukraine', 'der Irak', 'der Iran', 'der Sudan', 'die USA', 'die Niederlande'],
      exceptionNote: 'Feminine (die Schweiz, die Türkei), masculine (der Irak, der Iran), and plural-only (die USA, die Niederlande) countries always take an article — everything else usually doesn\'t.',
    ),
    GenderSuffixRuleItem(
      suffix: 'Letters',
      genderCode: 'n',
      certainty: '100%',
      title: 'Letters of the Alphabet are 100% Neuter (Das)',
      description: 'Every letter of the alphabet, used as a noun, is neuter.',
      examples: ['das A', 'das B', 'das Komma', 'das Alphabet'],
    ),
  ];
