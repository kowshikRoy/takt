                  ...
                  child: Column(
                    children: [
                      ...
                      Wrap(
                        ...
                        children: List.generate(exercise.sentenceParts.length, (
                          index,
                        ) {
                      ...
                      if (!_isChecked) ...[
                        ...
                        GridView.count(
                          ...
                          crossAxisSpacing: 12,
                          childAspectRatio:
                              3.0, // Flatter buttons to save space
                            ...
                            TextButton.icon(
                              onPressed: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Thank you for reporting! Our team will review this exercise.',
                                    ),
