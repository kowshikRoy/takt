...
Future<void> main(List<String> args) async {
  if (args.isEmpty) {
    print('Usage: dart run scripts/inspect_word.dart <word> [optional_db_path]');
    exit(1);
  }

  final targetWord = args[0].trim();

  // Initialize SQLite FFI for standalone Dart script execution
  sqfliteFfiInit();
  databaseFactory = databaseFactoryFfi;

  // Locate the latest DB from assets/ directory
  ...
  // Ensure default databases directory has our DB so DictionaryService connects to it
  ...
  print(' Inspecting word: "$targetWord"');
  print('============================================================\n');
